...
namespace Polyjuice.Potions.PtBr
{
    public static class Address
    {
        ...
        public static string City => Data.Cities.Rand();
        ...
        public static string StreetName
        {
            get
            {
                ...
                {
                    case 0:
                        return $"{Data.StreetPrefix.Rand()} {Name.FullName}";
                    case 1:
                        return $"{Data.StreetPrefix.Rand()} {Name.FirstName} {Name.LastName} {Name.LastName}";
                    default:
                        return string.Empty;
                }
            }
